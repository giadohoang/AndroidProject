...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String USGS_REQUEST_URL =
          ...
          //  "https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2014-01-01&endtime=2014-12-01&mitude=7";
    @Override
...
//check if url is empty
            ...
            try {
                ...
                //If the response request was successful (response code 200)
